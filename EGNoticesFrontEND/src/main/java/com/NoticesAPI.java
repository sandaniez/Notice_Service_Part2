...
public class NoticesAPI extends HttpServlet {
 ...
 // Convert request parameters to a Map
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String output = noticeObj.insertNotice(request.getParameter("nCategory"), 
				 request.getParameter("nTitle"), 
				request.getParameter("nDesc"), 
				request.getParameter("nDate"), 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 ...
		 paras.get("nCategory").toString(), 
		paras.get("nTitle").toString(), 
		paras.get("nDesc").toString(), 
		paras.get("nDate").toString(),
		paras.get("nAuthor").toString()); 
		response.getWriter().write(output);
	}
